  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'chinaNumerals 中文数字', link: 'chinaNumerals' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'DataView', link: 'is#DataView' },
        { text: 'Date (日期)', link: 'is#Date' },
        { text: 'File (文件)', link: 'is#File' },
        { text: 'FormData (表单数据)', link: 'is#FormData' },
        { text: 'Function (函数)', link: 'is#Function' },
        { text: 'Integer (整数)', link: 'is#Integer' },
        { text: 'Iterable (可迭代值)', link: 'is#Iterable' },
